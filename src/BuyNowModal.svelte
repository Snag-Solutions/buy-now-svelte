<script lang="ts">
    ...
    import { AllNetworkChains, EthereumMainnetChain } from './types/chain';
    ...
    const buyToken = async () => {
        ...
        try {
            ...
            if (error?.code === 4001) {
                ...
                newError = 'Something went wrong. Make sure you have enough ETH in your wallet.';
            }
    ...
    >
                    ...
                    {#if tokenListing?.reservoirListing}
                        <div class="">
                                    ...
                                    <div class="grow-0 text-2xl">
                                        <span class="flex flex-row items-center"
                                            ...
                                            /><span
                                                ...
                                                >{formatDollar(
                                                    tokenListing?.reservoirListing?.price.amount
                                                        .usd ?? 0,
                                                )}</span
                                            ></span
                                        >
                            ...
                            <div class="mt-5 text-xs text-secondary-text">
                                By connecting your wallet and using the marketplace, you agree to
                                our technology partner, Snag Solutions,<a
                                    target="_blank"
                                    rel="noreferrer"
                ...
                <div class="flex flex-col gap-8">
                    <div class="flex flex-row items-center gap-6">
                        ...
                        <div class="flex flex-col justify-between text-primary-text">
                            <div class="text-base font-semibold sm:text-xl">Confirm purchase</div>
                            <div class="text-sm">
            ...
            {#if buyListingState === BuyListingState.Success}
                <div class="flex-grow overflow-y-auto text-primary-text">
                    <div class="flex flex-col items-center gap-6 sm:gap-8">
                        <div class="relative h-[128px] w-[128px] sm:h-[256px] sm:w-[256px]">
                        ...
                        <div class="flex w-full flex-row gap-3 sm:w-auto">
                            ...
                            <Button
                                ...
                                href={shareLink}
                                ><span class="flex flex-row items-center gap-2 text-[#ffffff]">
        ...
        <svelte:fragment slot="footer">
            {#if !buyListingState}
                ...
                <Button
                    onClick={buyToken}
                    disabled={!connectedAccount || buyListingState === BuyListingState.Created}
